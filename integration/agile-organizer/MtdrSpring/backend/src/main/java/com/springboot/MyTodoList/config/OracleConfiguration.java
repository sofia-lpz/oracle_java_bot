...
public class OracleConfiguration {
    ...
    public DataSource dataSource() throws SQLException{
        ...
        ds.setURL("jdbc:oracle:thin:@reacttodosfnfo_tp?TNS_ADMIN=D:/oracle_java_bot/integration/agile-organizer/MtdrSpring/backend/src/Wallet");
        logger.info("Using URL: jdbc:oracle:thin:@reacttodosfnfo_tp?TNS_ADMIN=D:/oracle_java_bot/integration/agile-organizer/MtdrSpring/backend/src/Wallet");
        ds.setUser("TODOUSER");
